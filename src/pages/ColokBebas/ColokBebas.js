...
import BebasTable from "../../components/BebasTable/BebasTable";
...
import BebasDescription from "../../components/BebasDescription/BebasDescription";
import { getDiscounts, MAX_BETS, MIN_BETS } from "../../services/RuleService";
import { injectIntl } from "react-intl";
import { formatNumber } from "../../services/NumberService";


function ColokBebas(props) {

  const betType = "1D.STD";
...
export default injectIntl(ColokBebas);

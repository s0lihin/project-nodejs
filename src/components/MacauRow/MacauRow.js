...
function MacauRow({ rowsData, handleChange, handleValueChange, handleBlur }) {
    return (

        rowsData.map((data, index) => {
            const { num1, num2, betAmountOri, discount, betAmount, modified, checked  } = data;

...
import MacauRow from '../MacauRow/MacauRow';
import './MacauTable.scss';

function MacauTable({ rowsData, handleChange, handleValueChange, handleBlur, totalBetAmount, handleSubmit, handleReset }) {

    return (
        <div className='d-flex justify-content-center align-items-center'>
            <div className='app-table-form app-table-macau'>
                <div className="d-none d-md-flex app-theader">
                    <div className='d-flex py-2 app-trow'>
                        <div className='app-tcol'>#</div>
                        <div className='app-tcol'><FormattedMessage id="label.num" defaultMessage="Number" /></div>

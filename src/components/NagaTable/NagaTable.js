...
import NagaRow from '../NagaRow/NagaRow';
import './NagaTable.scss';

function NagaTable({ rowsData, handleChange, handleValueChange, handleBlur, totalBetAmount, handleSubmit, handleReset }) {

    return (
        <div className='d-flex justify-content-center align-items-center'>
            <div className='app-table-form app-table-naga'>

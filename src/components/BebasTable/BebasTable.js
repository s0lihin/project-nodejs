...
import BebasRow from '../BebasRow/BebasRow';
import { BET_ICON, RESET_ICON } from '../Icons/Icons';
import './BebasTable.scss';

function BebasTable({ rowsData, handleValueChange, totalBetAmount, handleSubmit, handleReset, handleBlur }) {

    return (
        <div className='d-flex justify-content-center align-items-center'>
            <div className='app-table-form app-table-bebas'>

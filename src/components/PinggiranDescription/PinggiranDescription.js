import { pinggiranRules } from "../../services/RuleService";
import { FormattedMessage } from 'react-intl';
import { formatNumber } from "../../services/NumberService";

function PinggiranDescription() {

    const rules = pinggiranRules();
        ...
        <div className='d-md-flex justify-content-center align-items-center'>
            <div className="rule">
                <table className='table table-borderless table-sm mb-0'>
                    ...
                    <tbody>
                        <tr>
                            <th style={{ width: 120 }}><FormattedMessage id="label.description" defaultMessage="message.pinggiran.description" /></th>
...
export default PinggiranDescription;